...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<a href="profile.php?un=' . $row['username_'] . '"><p><strong>' . $row['username_'] . ':</strong></p></a>';
        ...
        if ($commentResult->num_rows > 0) {
            ...
            while ($commentRow = $commentResult->fetch_assoc()) {
                ...
                // Make the username clickable
                echo '<a href="profile.php?un=' . $commentRow['username_'] . '"><strong>' . $commentRow['username_'] . ':</strong></a>';
