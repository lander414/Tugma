  ...
  <div class="top-rated-users">
    ...
    <ul class="top-rated-list">
      ...
      while ($topRatedRow = $topRatedResult->fetch_assoc()) {
        ...
        if (!empty($topRatedRow['extension']) && $topRatedRow['status'] == 1) {
            echo '<img src="../profilephoto/' . $topRatedRow['userid'] . '.' . $topRatedRow['extension'] . '" alt="">';
        } else {
            echo '<img src="../profilephoto/default.jpg" alt="">';  // Use default picture
        }
