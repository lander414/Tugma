...
<main class="main-container">
    ...
    <?php
      ...
      echo '<p class ="artist-rate">Average Rating of this Artist: ' . number_format($averageRating, 2) . '</p>';
    ?>

            </div>
            <?php
            if ($user["userid"] === $_SESSION["userid"]) {
                echo '<a href="../logic/upload.php" class="edit-profile-button">Edit Profile</a>';
            }
            ?>
